...
offerings and services can you use to generate these real-time reports?
   * A. Ingest the data through Amazon Kinesis Data Streams. Use Amazon Kinesis Data Analytics to query for sales per day for each product and sales per day for each customer using
